...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('blog.index')->with('toast_success', 'Post blog created successfully!');
    }
    ...
    public function update(Request $request, Blog $blog)
    {
        ...
        return redirect()->route('blog.index')->with('toast_success', 'Blog post update successfully!');
    }
    ...
    public function destroy(Blog $blog)
    {
        ...
        $blog->delete();
        return back()->with('toast_success', 'Post blog deleted Successfully');
    }
}
