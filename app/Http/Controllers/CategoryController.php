...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('category.index', compact('page_title', 'category'));
    }
    ...
    public function update(Request $request, Category $category)
    {
        ...
        if ($category->type == 0) {
            return redirect(route('category.index').'?type=menu')->with('toast_success', 'Category Update Successfully!');
        }else{
            return redirect(route('category.index').'?type=blog')->with('toast_success', 'Category Update Successfully!');
        }
    }
