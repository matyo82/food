...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('slider.index')->with('toast_success', 'Slider image Created Successfully!');
    }
    ...
    public function update(Request $request, Slider $slider)
    {
        ...
        return redirect()->route('slider.index')
            ->with('toast_success', 'slider image Update Successfully!');
    }
    ...
    public function destroy(Slider $slider)
    {
        ...
        $slider->delete();
        return back()->with('toast_success', 'Slider image deleted Successfully');
    }
}
