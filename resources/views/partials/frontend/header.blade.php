            ...
            <div class="container clearfix">
                ...
                <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                    ...
                    <div class="dz-social-icon">
                        <ul>
                            <li><a target="_blank" class="fab fa-facebook-f" href="{{ $general ? $general->facebook:'' }}"></a></li>
                            <li><a target="_blank" class="fab fa-twitter" href="{{ $general ? $general->twitter:'' }}"></a></li>
                            <li><a target="_blank" class="fab fa-instagram" href="{{ $general ? $general->instagram:'' }}"></a></li>
                        </ul>
                    </div>
                </div>
